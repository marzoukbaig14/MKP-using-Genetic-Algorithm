...
when item $j$ is included versus excluded. The closest prior work~\cite{hill1999monte,hill2005improving} 
proposed using a single global inclusion probability derived from a greedy 
heuristic, applied identically to all items. Our approach instead derives 
per-item probabilities from sub-generating functions, requires no objective 
function, and generalizes to any number of constraints. To our knowledge, 
the generating function connection has not previously been exploited for 
this purpose. The framework we develop yields a principled, interpretable, 
...
\begin{itemize}
    ...
    colleagues~\cite{hill2012test} showed that standard greedy repair 
...
\begin{enumerate}
    ...
    following the protocol of Hill et al.~\cite{hill2012test} with negative 
...
\bibitem{hill1999monte}
R.~R. Hill,
\textit{A Monte Carlo Study of Genetic Algorithm Initial Population Generation Methods},
In \textit{Proceedings of the 1999 Winter Simulation Conference},
eds. P.~A. Farrington, H.~B. Nembhard, D.~T. Sturrock, and G.~W. Evans,
pp. 543--547, 1999.

\bibitem{hill2005improving}
R.~R. Hill and C.~Hiremath,
\textit{Improving Genetic Algorithm Convergence Using Problem Structure and Domain Knowledge in Multidimensional Knapsack Problems},
International Journal of Operational Research,
1(1--2):145--159, 2005.

\bibitem{hill2012test}
R.~R. Hill, J.~T. Moore, C.~Hiremath, and Y.~K. Cho,
\textit{Test Problem Generation of Binary Knapsack Problem Variants and the Implications of their Use},
